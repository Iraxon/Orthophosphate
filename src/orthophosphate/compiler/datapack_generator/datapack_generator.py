...
from .datapack_directory_management import FolderRep, FileRep, datapack_directory, namespace_from_str, fzs, namespace_directory
...
def generate_datapack(ast: Node, name: typing.Optional[str]=None, in_secondary_namespace=None) -> FolderRep:
    ...
    namespace = namespace_from_str(name)
